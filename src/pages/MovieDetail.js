      ...
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <div className="p-5 flex justify-center items-center space-x-4">
            {isAdded ? (
              <button onClick={handleRemove} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded-full">Remove from Watchlist</button>
            ) : (
              <button onClick={handleAdd} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-full">Add to Watchlist</button>
            )}
          </div>
        </div>
      </section>
